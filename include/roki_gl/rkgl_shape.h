...
__ROKI_GL_EXPORT void rkglFrameAxisMaterial(zAxis a);
__ROKI_GL_EXPORT void rkglFrameHandleArrowParts(zFrame3D *f, zAxis a, double l, double mag);
__ROKI_GL_EXPORT void rkglFrameHandleTorusParts(zFrame3D *f, zAxis a, double l, double mag);
