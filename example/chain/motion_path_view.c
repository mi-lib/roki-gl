...
void dump_interpolated_path(char* filename){
  FILE *fp;
...
void register_ref_path_in_one_path_for_IK(rkChain* chain, int path_id)
{
  int ik_id;
...
double run_test(void)
{
  ...
  dump_interpolated_path( "motion_path_view.dat" );
